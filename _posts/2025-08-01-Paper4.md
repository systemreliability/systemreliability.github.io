...
A journal paper, titled “Dual graph-based Bayesian network modeling with Rao-Blackwellization for seismic reliability and complexity quantification of network connectivity” {% cite lee2025dual %}, was recently published in _Earthquake Engineering & Structural Dynamics_. The paper was co-authored by me, [Prof. Ji-Eun Byun](https://jieunbyun.github.io/) (Imperial College London), and [Prof. Junho Song](https://systemreliability.wordpress.com) (Seoul National University).
...
> Lee, D., Byun, J.E., & Song, J. (2025). [Dual graph-based Bayesian network modeling with Rao-Blackwellization for seismic reliability and complexity quantification of network connectivity](https://snu.elsevierpure.com/en/publications/dual-graph-based-bayesian-network-modeling-with-rao-blackwellizat). _Earthquake Engineering & Structural Dynamics_. Vol. 54(10), 2387-2402.
