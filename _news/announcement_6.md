---
layout: post
title: [New paper] Efficient seismic reliability and fragility analysis of lifeline networks using subset simulation
...
A journal paper, titled “Efficient seismic reliability and fragility analysis of lifeline networks using subset simulation” was recently published in Reliability Engineering & System Safety. The paper was co-authored by Dr. Dongkyu Lee (a former Ph.D. student member of SSRG, now a postdoctoral researcher at TU Munich), [Prof. Ziqi Wang](https://coezresearch.wpenginepowered.com/) (UC Berkeley), and [Prof. Junho Song](https://systemreliability.wordpress.com/) (SSRG).
